...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        log.info("Checking inventory and seeding missing products...");
        ...
        for (Inventory item : defaultProducts) {
            ...
            if (!inventoryDao.existsByProductCode(item.getProductCode())) {
                inventoryDao.save(item);
                log.info("Inserted product: {}", item.getProductCode());
            } else {
                log.info("Product already exists: {}", item.getProductCode());
            }
        }
